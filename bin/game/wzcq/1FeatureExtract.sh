...
--class server.game.wzcq.FeatureExport  \
--num-executors 40 --executor-memory 3G --executor-cores 2 --driver-memory 2G \
...
customer_model_predict_age_sex-1.0-SNAPSHOT.jar $1 $2>> run1.log 2>&1