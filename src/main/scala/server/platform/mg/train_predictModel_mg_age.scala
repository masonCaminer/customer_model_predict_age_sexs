...
import server.platform.mg.PropertiesFactory._
...
/**
  * 训练年龄
  */
object train_predictModel_mg_age {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val trainRawData = getModelInputFromHive_train(dbPath, spark, "age").coalesce(200)
    trainRawData.cache()
