...
object PropertiesFactory {
  val propertiesPATH: String = "/platform/xy/xy_user_predict.properties"
  ...
  lazy val feamanageHiveTable = propertiesLoad.getProperties("feamanageHiveTable")
  lazy val sex_train = propertiesLoad.getProperties("sex_train")
  lazy val age_train = propertiesLoad.getProperties("age_train")
