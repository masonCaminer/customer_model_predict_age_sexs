...
//    删除特征中间表和结果表的前7日当天数据
    spark_tools.delete_HiveDsBeforeNum(FeatureTable,yester_ds,7,spark,"widetab")
    spark_tools.delete_ExternalTablefromHive(FeatureTable,yester_ds,7,spark,"widetab")
